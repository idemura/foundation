...
void
string_of(string_t *s, const char *str, size_t len)
{
    if (len == 0) {
        s->str = nullptr;
    } else {
...
void
string_of_sz(string_t *s, const char *str)
{
    string_of(s, str, strlen(str));
}

void
string_copy(string_t *s, string_t const *other)
{
...
bool
string_equal_sz(string_t const *s, const char *str)
{
